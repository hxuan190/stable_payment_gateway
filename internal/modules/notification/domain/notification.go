...
type NotificationLog struct {
	...
	ProviderResponse  database.JSONBMap `gorm:"type:jsonb" json:"provider_response,omitempty"`
...
type MerchantNotificationPreference struct {
	...
	Config database.JSONBMap `gorm:"type:jsonb;default:'{}'" json:"config"`
	...
	TestConfig database.JSONBMap `gorm:"type:jsonb" json:"test_config,omitempty"`
...
func (mnp *MerchantNotificationPreference) SetConfigValue(key string, value interface{}) {
	if mnp.Config == nil {
		mnp.Config = make(database.JSONBMap)
	}
