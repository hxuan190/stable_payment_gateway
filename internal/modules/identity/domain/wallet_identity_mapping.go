...
type WalletIdentityMapping struct {
	...
	Blockchain        paymentDomain.Chain `gorm:"type:varchar(20);not null;uniqueIndex:idx_wallet_blockchain" json:"blockchain"`
...
func (wm *WalletIdentityMapping) IsKYCVerified() bool {
	return wm.KYCStatus == domain.KYCStatusApproved
}
