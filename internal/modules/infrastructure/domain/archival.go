...
type ArchivedRecord struct {
	...
	// Metadata
	RecordDataSample database.JSONBMap `gorm:"type:jsonb" json:"record_data_sample,omitempty"` // Small sample
...
type TransactionHash struct {
	...
	// Record Snapshot
	RecordSnapshot database.JSONBMap `gorm:"type:jsonb" json:"record_snapshot,omitempty"`
