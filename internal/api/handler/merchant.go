...
func (h *MerchantHandler) RegisterMerchant(c *gin.Context) {
	...
	response := dto.APIResponse{
		Data: dto.RegisterMerchantResponse{
...
func (h *MerchantHandler) GetBalance(c *gin.Context) {
	...
	// Build response
	response := dto.APIResponse{
		Data: dto.MerchantBalanceResponse{
...
func (h *MerchantHandler) GetTransactions(c *gin.Context) {
	...
	transactions := make([]dto.TransactionItem, 0, len(payments))
	...
	response := dto.APIResponse{
		Data: dto.TransactionListResponse{
			...
			Pagination: dto.TransactionPaginationMeta{
...
func (h *MerchantHandler) GetProfile(c *gin.Context) {
	...
	// Build response
	profile := dto.MerchantProfileResponse{
		MerchantID:   merchant.ID,
		Email:        merchant.Email,
